...
public class Config {
    ...
    public static final class Common {
        ...
        public Common() {
            ...
            bloodMeshDurability = COMMON_BUILDER.comment("What the max durability of the CreateSifter brass mesh should be.").defineInRange("CreateSifterAddons.BloodMeshDurability", 512, 0, Integer.MAX_VALUE);
            bloodMeshTakeDurability = COMMON_BUILDER.define("CreateSifterAddons.BloodMeshTakesDurability", true);
            manaMeshDurability = COMMON_BUILDER.comment("What the max durability of the CreateSifter brass mesh should be.").defineInRange("CreateSifterAddons.ManaMeshDurability", 512, 0, Integer.MAX_VALUE);
            manaMeshTakeDurability = COMMON_BUILDER.define("CreateSifterAddons.ManaMeshTakesDurability", true);
            steelMeshDurability = COMMON_BUILDER.comment("What the max durability of the CreateSifter brass mesh should be.").defineInRange("CreateSifterAddons.SteelMeshDurability", 512, 0, Integer.MAX_VALUE);
            steelMeshTakeDurability = COMMON_BUILDER.define("CreateSifterAddons.SteelMeshTakesDurability", true);
            leadMeshDurability = COMMON_BUILDER.comment("What the max durability of the CreateSifter brass mesh should be.").defineInRange("CreateSifterAddons.LeadMeshDurability", 512, 0, Integer.MAX_VALUE);
